...
## Purpose
Define the layered configuration loader that replaces scattered environment-variable parsing with a single typed `Config` struct backed by a human-readable file, environment variables, and CLI flags.
