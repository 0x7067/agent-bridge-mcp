...
- **THEN** `task_wait`, `task_status`, and `task_result` report a final failed task without requiring `task_stop`
...
- **WHEN** a caller invokes `task_preview` for Codex implementation work
