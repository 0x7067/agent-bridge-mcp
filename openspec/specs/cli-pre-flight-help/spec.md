...
## Purpose
Define the command-line preflight surface that lets operators inspect usage,
validate configuration, and run provider smoke checks without entering the MCP
stdio loop.
## Requirements
