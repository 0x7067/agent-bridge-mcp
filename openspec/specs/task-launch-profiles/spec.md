...
The system SHALL provide a `bare` launch profile that uses compact bridge-owned instructions and disables or bypasses provider hooks, skills, session memory, context files, and ambient configuration where the provider supports it.
