# claude-host-runner Specification

## Purpose
Define the opt-in Claude host runner that executes structured Claude provider requests outside the Codex sandbox while preserving workspace safety, bounded output, and inspectable lifecycle behavior.
## Requirements
