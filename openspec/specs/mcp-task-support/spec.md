# mcp-task-support Specification

## Purpose
Define the compatibility gate for protocol-level MCP task support while Agent
Bridge keeps the native `agent_*` lifecycle as the supported collaboration
surface.
## Requirements
